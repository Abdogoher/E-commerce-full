...
const Article1 = () => {
  return (
    <div className="">
      {/* image article */}
      <Image
        src="/assets/images/blog-3.jpg.png"
        alt="..."
        width={855}
        height={600}
      ...
      {/* article body */}
      <div className="">
        <p className="text-gray-400 text-[6px] md:text-xs py-1 md:py-4">GROCERY</p>
        <h2 className="text-xs md:text-4xl font-semibold pr-4 inter">
          But I must explain to you how all this mistaken idea
        </h2>
        <div className="py-[1px] md:py-2">
          <span className="text-gray-400 text-[6px] text-xs mr-[2px] md:mr-1">jan 13 2025</span> <span className="text-[8px] md:text-sm">Sinan ISIK</span>
        </div>
